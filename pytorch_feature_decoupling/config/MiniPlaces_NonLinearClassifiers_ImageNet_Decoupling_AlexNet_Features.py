...
pretrained = '../_experiments/TinyImageNet_Decoupling_AlexNet/feature_net_epoch50'
networks['feat_extractor'] = {'def_file': 'architectures/AlexNetFeature.py', 'pretrained': pretrained, 'opt': {},  'optim_params': None} 

net_opt_cls = [None] * 2
net_opt_cls[0] = {'cls_type':'Alexnet_conv4', 'nChannels':256, 'num_classes':100}
net_opt_cls[1] = {'cls_type':'Alexnet_conv5', 'nChannels':256, 'num_classes':100}
